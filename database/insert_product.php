...
if(!$con){
    ...
    if(isset($_post['insert_pro']))
    {
        ...
        VALUES ('$pro_title','$pro_cat','$pro_brand','$pro_price','$pro_desc','$pro_kw')";
    ...
    //   this  is display
    $sql = "SELECT pro_title, pro_cat, pro_brand,pro_price,pro_desc,pro_keywords FROM Tech Box";
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "pro_title: " . $row["pro_title"]. " - pro_cat: " . $row["pro_cat"]. " " ." - pro_brand: " . $row["pro_brand"]. " - pro_price: " . $row["pro_price"]. " - pro_desc: " . $row["pro_desc"]. " - pro_keywords: " . $row["pro_keywords"]  . "<br>";
        }
    }
    else {
        echo "0 results";
